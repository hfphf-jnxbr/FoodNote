...
class CanvasPaint(context: Context, private val colorCardBackground: Int) : View(context),
    View.OnTouchListener, CanvasInterface {
    ...
    override fun setAlphaColor(alpha: Int) {
        this.alpha = alpha
    }

    override fun setColorBackground(color: Int) {
        this.color = color
    }
